...
function renderHeatmapSvg(entries, vpWidth, vpHeight) {
    ...
    for (const entry of entries) {
        ...
        for (const src of entry.sources) {
            ...
            rects.push(`<line x1="${px}" y1="${py}" x2="${cx}" y2="${cy}" ` +
...
// Breakdown table
// ————————————————————————————————————————————
function renderBreakdownTable(breakdowns) {
...
function buildHtmlReport(report, options = {}) {
    ...
    const breakdowns = (0, breakdown_1.buildElementBreakdown)(report.entries);
    // — Sections —
 ...
 */
function saveHtmlReport(html, filePath) {
